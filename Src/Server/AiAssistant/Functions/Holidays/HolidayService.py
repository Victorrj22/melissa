...
class HolidayService:
    ...
    def get_holidays(self, state: str, year: int) -> List[Holiday]:
        if self.__from_online_source:
            return self.__fetch_from_external_api(state, year)

        return self.__fetch_from_local_data(state, year)


    @staticmethod
    def __fetch_from_external_api(state: str, year: int) -> List[Holiday]:
    ...
    @staticmethod
    def __fetch_from_local_data(state: str, year: int) -> List[Holiday]:
