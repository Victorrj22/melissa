...
token = "17321|H0sCrqpfrb5QNeRXA5mQDxD243eyaqIP";

class Holiday:
    #Faz o mapemanto do retorno da API
...
def get_holidays(state: str, year: int, token: str) -> List[Holiday]:
    endpoint = f"https://api.invertexto.com/v1/holidays/{year}?token={token}&state={state}";
    try:
